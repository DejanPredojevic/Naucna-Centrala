...
insert into user_data(id, email, grad, ime, odobren_recenzent, password, prezime, recenzent, scientific_area, titula, username, role) values 
(3,'urednik1@gmail.com','kula','urednik1',true,'urednik1','urednik1',true,'urednik1' , 'urednik1', 'urednik1', 'urednik');
insert into user_data(id, email, grad, ime, odobren_recenzent, password, prezime, recenzent, scientific_area, titula, username, role) values 
(4,'recenzent@gmail.com','kula','recenzent',true,'recenzent','recenzent',true,'recenzent' , 'recenzent', 'recenzent', 'recenzent');
insert into user_data(id, email, grad, ime, odobren_recenzent, password, prezime, recenzent, scientific_area, titula, username, role) values 
(5,'recenzent1@gmail.com','kula','recenzent1',true,'recenzent1','recenzent1',true,'recenzent1' , 'recenzent1', 'recenzent1', 'recenzent');
