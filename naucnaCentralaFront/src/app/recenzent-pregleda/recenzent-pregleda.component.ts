...
@Component({
  selector: 'app-recenzent-pregleda',
  templateUrl: './recenzent-pregleda.component.html',
  styleUrls: ['./recenzent-pregleda.component.css']
})
export class RecenzentPregledaComponent implements OnInit {
